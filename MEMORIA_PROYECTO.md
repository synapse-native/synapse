...
> Última actualización: 2026-08-10 (sesión R11 — exhaustividad `coincidir` nativa CERRADA; checklist 2.6 ✅; siguiente: R12 préstamos).
...
- **Próximo paso:** **R12** — préstamos M21.4 nativos: verificar el cableado de NODO_PUNTERO (flatten→analizador) con el patrón de `tests/integration/test_borrowing.py` (prioridad P2); luego R1 (TVars nativo).

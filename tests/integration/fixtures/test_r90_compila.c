...
int64_t suma_hasta(int64_t lim);
int64_t visible(int64_t v);
...
int64_t clasifica(int64_t n) {
    {
        int64_t _match_624187878293577384 = n;
        switch (_match_624187878293577384) {
            case 0:
            {
                escribir_linea((CadenaSegura){ .longitud = (int)strlen("cero"), .datos = "cero" });
                break;
                  /* [Lifetime Scope: exit depth=1] */
            }
            default:
            {
                escribir_linea((CadenaSegura){ .longitud = (int)strlen("otro"), .datos = "otro" });
                break;
                  /* [Lifetime Scope: exit depth=1] */
            }
        }
...
int64_t principal(void) {
    _simd_detectar();
    int64_t r = clasifica(0LL);
    int64_t s = suma_hasta(4LL);
    escribir_linea(entero_a_texto(s));
    int64_t v = visible(3LL);

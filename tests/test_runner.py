...
SYNAPSE_RT_MEMORY = os.path.join(PROJECT_ROOT, "synapse_rt_memory.o")
SYNAPSE_RT_CONCURRENCY = os.path.join(PROJECT_ROOT, "synapse_rt_concurrency.o")
...
def probar_archivo(syn_path):
    ...
    c_file = base + ".c"
    exe_file = base + ".exe"
    cmd_link = ["gcc", "-O2", c_file, SYNAPSE_RT, SYNAPSE_RT_MEMORY, SYNAPSE_RT_CONCURRENCY, "-o", exe_file, "-lpthread"]

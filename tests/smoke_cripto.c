...
void principal(void) {
    CadenaSegura hash = {0};
    _simd_detectar();
    _syn_texto_liberar(hash);
    hash = sha256_texto((CadenaSegura){ .longitud = (int)strlen("hola"), .datos = "hola" });
    printf("%s %s\
", (CadenaSegura){ .longitud = (int)strlen("SHA-256 de hola: "), .datos = "SHA-256 de hola: " }.datos, hash.datos);
    if (((hash).longitud == 64LL)) {
        printf("%s\
", (CadenaSegura){ .longitud = (int)strlen("sha256 longitud OK"), .datos = "sha256 longitud OK" }.datos);
          /* [Lifetime Scope: exit depth=1] */
    }
    else {
        printf("%s\
", (CadenaSegura){ .longitud = (int)strlen("FALLO sha256 longitud"), .datos = "FALLO sha256 longitud" }.datos);
          /* [Lifetime Scope: exit depth=1] */
    }
    if ((str_eq(hash, (CadenaSegura){ .longitud = (int)strlen("b221d9dbb083a7f33428d7c2a3c3198ae925614d70210e28716ccaa7cd4ddb79"), .datos = "b221d9dbb083a7f33428d7c2a3c3198ae925614d70210e28716ccaa7cd4ddb79" }) == 1)) {
        printf("%s\
", (CadenaSegura){ .longitud = (int)strlen("sha256 valor OK"), .datos = "sha256 valor OK" }.datos);
          /* [Lifetime Scope: exit depth=1] */
    }
    else {
        printf("%s %s\
", (CadenaSegura){ .longitud = (int)strlen("FALLO sha256 valor: "), .datos = "FALLO sha256 valor: " }.datos, hash.datos);
          /* [Lifetime Scope: exit depth=1] */
    }
    printf("%s\

...
void fallar(CadenaSegura nombre, CadenaSegura esp, CadenaSegura obs);
void fallar_e(CadenaSegura nombre, int64_t esp, int64_t obs);
...
void pasar(CadenaSegura nombre);
...
void test_a_texto_entero(void);
void test_atoi_negativo(void);
void test_atoi_normal(void);
void test_cmp_texto_igual(void);
void test_cmp_texto_mayor(void);
void test_cmp_texto_menor(void);
void test_contiene_basico(void);
void test_strchr_encontrado(void);
void test_strchr_no_encontrado(void);
void test_strcpy_normal(void);
void test_strlen_normal(void);
void test_strlen_vacio(void);
void test_strncpy_normal(void);
void test_strstr_encontrado(void);
void test_strstr_no_encontrado(void);
...
int64_t t_pasados = 0LL;
int64_t t_fallidos = 0LL;
CadenaSegura _validar_ruta_segura(CadenaSegura ruta) {
...
void fallar(CadenaSegura nombre, CadenaSegura esp, CadenaSegura obs) {
    ...
    escribir_linea(concat(concat((CadenaSegura){ .longitud = (int)strlen("    Esperado: \""), .datos = "    Esperado: \"" }, esp), (CadenaSegura){ .longitud = (int)strlen("\""), .datos = "\"" }));
    escribir_linea(concat(concat((CadenaSegura){ .longitud = (int)strlen("    Obtenido: \""), .datos = "    Obtenido: \"" }, obs), (CadenaSegura){ .longitud = (int)strlen("\""), .datos = "\"" }));
    t_fallidos = (t_fallidos + 1LL);
      /* [Lifetime Scope: exit depth=0] */
    _syn_texto_liberar(obs);
    _syn_texto_liberar(nombre);
    _syn_texto_liberar(esp);
}

void fallar_e(CadenaSegura nombre, int64_t esp, int64_t obs) {
    int64_t t_fallidos;
    escribir_linea(concat((CadenaSegura){ .longitud = (int)strlen("  FAIL: "), .datos = "  FAIL: " }, nombre));
    escribir_linea(concat((CadenaSegura){ .longitud = (int)strlen("    Esperado: "), .datos = "    Esperado: " }, entero_a_texto(esp)));
    escribir_linea(concat((CadenaSegura){ .longitud = (int)strlen("    Obtenido: "), .datos = "    Obtenido: " }, entero_a_texto(obs)));
    t_fallidos = (t_fallidos + 1LL);
      /* [Lifetime Scope: exit depth=0] */
    _syn_texto_liberar(nombre);
}
...
int64_t _principal_impl(void) {
    _simd_detectar();
    escribir_linea((CadenaSegura){ .longitud = (int)strlen("=== test_lsp_io_v2.syn — TDD Tests LSP I/O v2 ==="), .datos = "=== test_lsp_io_v2.syn — TDD Tests LSP I/O v2 ===" });
    escribir_linea((CadenaSegura){ .longitud = (int)strlen(""), .datos = "" });
    escribir_linea((CadenaSegura){ .longitud = (int)strlen("--- cmp_texto ---"), .datos = "--- cmp_texto ---" });
    test_cmp_texto_igual();
    test_cmp_texto_menor();
    test_cmp_texto_mayor();
    escribir_linea((CadenaSegura){ .longitud = (int)strlen(""), .datos = "" });
    escribir_linea((CadenaSegura){ .longitud = (int)strlen("--- strlen_s ---"), .datos = "--- strlen_s ---" });
    test_strlen_normal();
    test_strlen_vacio();
    escribir_linea((CadenaSegura){ .longitud = (int)strlen(""), .datos = "" });
    escribir_linea((CadenaSegura){ .longitud = (int)strlen("--- strstr_f ---"), .datos = "--- strstr_f ---" });
    test_strstr_encontrado();
    test_strstr_no_encontrado();
    escribir_linea((CadenaSegura){ .longitud = (int)strlen(""), .datos = "" });
    escribir_linea((CadenaSegura){ .longitud = (int)strlen("--- strchr_f ---"), .datos = "--- strchr_f ---" });
    test_strchr_encontrado();
    test_strchr_no_encontrado();
    escribir_linea((CadenaSegura){ .longitud = (int)strlen(""), .datos = "" });
    escribir_linea((CadenaSegura){ .longitud = (int)strlen("--- atoi_f ---"), .datos = "--- atoi_f ---" });
    test_atoi_normal();
    test_atoi_negativo();
    escribir_linea((CadenaSegura){ .longitud = (int)strlen(""), .datos = "" });
    escribir_linea((CadenaSegura){ .longitud = (int)strlen("--- strcpy_f ---"), .datos = "--- strcpy_f ---" });
    test_strcpy_normal();
    escribir_linea((CadenaSegura){ .longitud = (int)strlen(""), .datos = "" });
    escribir_linea((CadenaSegura){ .longitud = (int)strlen("--- strncpy_f ---"), .datos = "--- strncpy_f ---" });
    test_strncpy_normal();
    escribir_linea((CadenaSegura){ .longitud = (int)strlen(""), .datos = "" });
    escribir_linea((CadenaSegura){ .longitud = (int)strlen("--- a_texto ---"), .datos = "--- a_texto ---" });
    test_a_texto_entero();
    escribir_linea((CadenaSegura){ .longitud = (int)strlen(""), .datos = "" });
    escribir_linea((CadenaSegura){ .longitud = (int)strlen("--- contiene ---"), .datos = "--- contiene ---" });
    test_contiene_basico();
    escribir_linea((CadenaSegura){ .longitud = (int)strlen(""), .datos = "" });
    escribir_linea((CadenaSegura){ .longitud = (int)strlen("=== RESUMEN ==="), .datos = "=== RESUMEN ===" });
    escribir_linea(concat((CadenaSegura){ .longitud = (int)strlen("Pasados: "), .datos = "Pasados: " }, entero_a_texto(t_pasados)));
    escribir_linea(concat((CadenaSegura){ .longitud = (int)strlen("Fallidos: "), .datos = "Fallidos: " }, entero_a_texto(t_fallidos)));
    if ((t_fallidos > 0LL)) {
...
void test_a_texto_entero(void) {
    CadenaSegura r = a_texto(123LL);
    if ((str_eq(r, (CadenaSegura){ .longitud = (int)strlen("123"), .datos = "123" }) == 1)) {
        pasar((CadenaSegura){ .longitud = (int)strlen("a_texto(123) == '123'"), .datos = "a_texto(123) == '123'" });
          /* [Lifetime Scope: exit depth=1] */
    }
    else {
        fallar((CadenaSegura){ .longitud = (int)strlen("a_texto entero"), .datos = "a_texto entero" }, (CadenaSegura){ .longitud = (int)strlen("123"), .datos = "123" }, r);
          /* [Lifetime Scope: exit depth=1] */
    }
      /* [Lifetime Scope: exit depth=0] */
...
void test_atoi_negativo(void) {
    int64_t r = atoi_f((CadenaSegura){ .longitud = (int)strlen("-7"), .datos = "-7" });
    if ((r == (-7LL))) {
        pasar((CadenaSegura){ .longitud = (int)strlen("atoi_f('-7') == -7"), .datos = "atoi_f('-7') == -7" });
          /* [Lifetime Scope: exit depth=1] */
    }
    else {
        fallar_e((CadenaSegura){ .longitud = (int)strlen("atoi negativo"), .datos = "atoi negativo" }, (-7LL), r);
          /* [Lifetime Scope: exit depth=1] */
    }
      /* [Lifetime Scope: exit depth=0] */
}
...
void test_atoi_normal(void) {
    int64_t r = atoi_f((CadenaSegura){ .longitud = (int)strlen("42"), .datos = "42" });
    if ((r == 42LL)) {
        pasar((CadenaSegura){ .longitud = (int)strlen("atoi_f('42') == 42"), .datos = "atoi_f('42') == 42" });
          /* [Lifetime Scope: exit depth=1] */
    }
    else {
        fallar_e((CadenaSegura){ .longitud = (int)strlen("atoi normal"), .datos = "atoi normal" }, 42LL, r);
          /* [Lifetime Scope: exit depth=1] */
    }
      /* [Lifetime Scope: exit depth=0] */
}
...
void test_cmp_texto_igual(void) {
    int64_t r = cmp_texto((CadenaSegura){ .longitud = (int)strlen("hola"), .datos = "hola" }, (CadenaSegura){ .longitud = (int)strlen("hola"), .datos = "hola" });
    if ((r == 0LL)) {
        pasar((CadenaSegura){ .longitud = (int)strlen("cmp_texto('hola','hola') == 0"), .datos = "cmp_texto('hola','hola') == 0" });
          /* [Lifetime Scope: exit depth=1] */
    }
    else {
        fallar_e((CadenaSegura){ .longitud = (int)strlen("cmp_texto igual"), .datos = "cmp_texto igual" }, 0LL, r);
          /* [Lifetime Scope: exit depth=1] */
    }
      /* [Lifetime Scope: exit depth=0] */
}
...
void test_cmp_texto_mayor(void) {
    int64_t r = cmp_texto((CadenaSegura){ .longitud = (int)strlen("abd"), .datos = "abd" }, (CadenaSegura){ .longitud = (int)strlen("abc"), .datos = "abc" });
    if ((r > 0LL)) {
        pasar((CadenaSegura){ .longitud = (int)strlen("cmp_texto('abd','abc') > 0"), .datos = "cmp_texto('abd','abc') > 0" });
          /* [Lifetime Scope: exit depth=1] */
    }
    else {
        fallar_e((CadenaSegura){ .longitud = (int)strlen("cmp_texto mayor"), .datos = "cmp_texto mayor" }, 1LL, r);
          /* [Lifetime Scope: exit depth=1] */
    }
      /* [Lifetime Scope: exit depth=0] */
}
...
void test_cmp_texto_menor(void) {
    int64_t r = cmp_texto((CadenaSegura){ .longitud = (int)strlen("abc"), .datos = "abc" }, (CadenaSegura){ .longitud = (int)strlen("abd"), .datos = "abd" });
    if ((r < 0LL)) {
        pasar((CadenaSegura){ .longitud = (int)strlen("cmp_texto('abc','abd') < 0"), .datos = "cmp_texto('abc','abd') < 0" });
          /* [Lifetime Scope: exit depth=1] */
    }
    else {
        fallar_e((CadenaSegura){ .longitud = (int)strlen("cmp_texto menor"), .datos = "cmp_texto menor" }, (-1LL), r);
          /* [Lifetime Scope: exit depth=1] */
    }
      /* [Lifetime Scope: exit depth=0] */
}
...
void test_contiene_basico(void) {
    int64_t r = contiene((CadenaSegura){ .longitud = (int)strlen("synapse_lsp"), .datos = "synapse_lsp" }, (CadenaSegura){ .longitud = (int)strlen("lsp"), .datos = "lsp" });
    if ((r == 1LL)) {
        pasar((CadenaSegura){ .longitud = (int)strlen("contiene('synapse_lsp', 'lsp') == 1"), .datos = "contiene('synapse_lsp', 'lsp') == 1" });
          /* [Lifetime Scope: exit depth=1] */
    }
    else {
        fallar_e((CadenaSegura){ .longitud = (int)strlen("contiene basico"), .datos = "contiene basico" }, 1LL, r);
          /* [Lifetime Scope: exit depth=1] */
    }
      /* [Lifetime Scope: exit depth=0] */
}
...
void test_strchr_encontrado(void) {
    int64_t r = strchr_f((CadenaSegura){ .longitud = (int)strlen("a:b:c"), .datos = "a:b:c" }, 58LL);
    if ((r == 1LL)) {
        pasar((CadenaSegura){ .longitud = (int)strlen("strchr_f('a:b:c', ':') == 1"), .datos = "strchr_f('a:b:c', ':') == 1" });
          /* [Lifetime Scope: exit depth=1] */
    }
    else {
        fallar_e((CadenaSegura){ .longitud = (int)strlen("strchr encontrado"), .datos = "strchr encontrado" }, 1LL, r);
          /* [Lifetime Scope: exit depth=1] */
    }
      /* [Lifetime Scope: exit depth=0] */
}
...
void test_strchr_no_encontrado(void) {
    int64_t r = strchr_f((CadenaSegura){ .longitud = (int)strlen("abc"), .datos = "abc" }, 58LL);
    if ((r == (-1LL))) {
        pasar((CadenaSegura){ .longitud = (int)strlen("strchr_f('abc', ':') == -1"), .datos = "strchr_f('abc', ':') == -1" });
          /* [Lifetime Scope: exit depth=1] */
    }
    else {
        fallar_e((CadenaSegura){ .longitud = (int)strlen("strchr no encontrado"), .datos = "strchr no encontrado" }, (-1LL), r);
          /* [Lifetime Scope: exit depth=1] */
    }
      /* [Lifetime Scope: exit depth=0] */
}
...
void test_strcpy_normal(void) {
    CadenaSegura r = strcpy_f((CadenaSegura){ .longitud = (int)strlen("hola"), .datos = "hola" });
    if ((str_eq(r, (CadenaSegura){ .longitud = (int)strlen("hola"), .datos = "hola" }) == 1)) {
        pasar((CadenaSegura){ .longitud = (int)strlen("strcpy_f('hola') == 'hola'"), .datos = "strcpy_f('hola') == 'hola'" });
          /* [Lifetime Scope: exit depth=1] */
    }
    else {
        fallar((CadenaSegura){ .longitud = (int)strlen("strcpy normal"), .datos = "strcpy normal" }, (CadenaSegura){ .longitud = (int)strlen("hola"), .datos = "hola" }, r);
          /* [Lifetime Scope: exit depth=1] */
    }
      /* [Lifetime Scope: exit depth=0] */
    _syn_texto_liberar(r);
...
void test_strlen_normal(void) {
    int64_t r = strlen_s((CadenaSegura){ .longitud = (int)strlen("hola"), .datos = "hola" });
    if ((r == 4LL)) {
        pasar((CadenaSegura){ .longitud = (int)strlen("strlen_s('hola') == 4"), .datos = "strlen_s('hola') == 4" });
          /* [Lifetime Scope: exit depth=1] */
    }
    else {
        fallar_e((CadenaSegura){ .longitud = (int)strlen("strlen normal"), .datos = "strlen normal" }, 4LL, r);
          /* [Lifetime Scope: exit depth=1] */
    }
      /* [Lifetime Scope: exit depth=0] */
}
...
void test_strlen_vacio(void) {
    int64_t r = strlen_s((CadenaSegura){ .longitud = (int)strlen(""), .datos = "" });
    if ((r == 0LL)) {
        pasar((CadenaSegura){ .longitud = (int)strlen("strlen_s('') == 0"), .datos = "strlen_s('') == 0" });
          /* [Lifetime Scope: exit depth=1] */
    }
    else {
        fallar_e((CadenaSegura){ .longitud = (int)strlen("strlen vacio"), .datos = "strlen vacio" }, 0LL, r);
          /* [Lifetime Scope: exit depth=1] */
    }
      /* [Lifetime Scope: exit depth=0] */
}
...
void test_strncpy_normal(void) {
    CadenaSegura r = strncpy_f((CadenaSegura){ .longitud = (int)strlen("hola mundo"), .datos = "hola mundo" }, 4LL);
    if ((str_eq(r, (CadenaSegura){ .longitud = (int)strlen("hola"), .datos = "hola" }) == 1)) {
        pasar((CadenaSegura){ .longitud = (int)strlen("strncpy_f('hola mundo', 4) == 'hola'"), .datos = "strncpy_f('hola mundo', 4) == 'hola'" });
          /* [Lifetime Scope: exit depth=1] */
    }
    else {
        fallar((CadenaSegura){ .longitud = (int)strlen("strncpy normal"), .datos = "strncpy normal" }, (CadenaSegura){ .longitud = (int)strlen("hola"), .datos = "hola" }, r);
          /* [Lifetime Scope: exit depth=1] */
    }
      /* [Lifetime Scope: exit depth=0] */
    _syn_texto_liberar(r);
...
void test_strstr_encontrado(void) {
    int64_t r = strstr_f((CadenaSegura){ .longitud = (int)strlen("Content-Length: 50"), .datos = "Content-Length: 50" }, (CadenaSegura){ .longitud = (int)strlen("Length"), .datos = "Length" });
    if ((r == 8LL)) {
        pasar((CadenaSegura){ .longitud = (int)strlen("strstr_f('Content-Length: 50', 'Length') == 8"), .datos = "strstr_f('Content-Length: 50', 'Length') == 8" });
          /* [Lifetime Scope: exit depth=1] */
    }
    else {
        fallar_e((CadenaSegura){ .longitud = (int)strlen("strstr encontrado"), .datos = "strstr encontrado" }, 8LL, r);
          /* [Lifetime Scope: exit depth=1] */
    }
      /* [Lifetime Scope: exit depth=0] */
}
...
void test_strstr_no_encontrado(void) {
    int64_t r = strstr_f((CadenaSegura){ .longitud = (int)strlen("hola"), .datos = "hola" }, (CadenaSegura){ .longitud = (int)strlen("z"), .datos = "z" });
    if ((r == (-1LL))) {
        pasar((CadenaSegura){ .longitud = (int)strlen("strstr_f('hola', 'z') == -1"), .datos = "strstr_f('hola', 'z') == -1" });
          /* [Lifetime Scope: exit depth=1] */
    }
    else {
        fallar_e((CadenaSegura){ .longitud = (int)strlen("strstr no encontrado"), .datos = "strstr no encontrado" }, (-1LL), r);
          /* [Lifetime Scope: exit depth=1] */
    }
      /* [Lifetime Scope: exit depth=0] */
}

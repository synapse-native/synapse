...
enum opt_code
{
  ...
  /* OPT_mgather = 1853, */                  /* -mgather */
  OPT_mgeneral_regs_only = 1854,             /* -mgeneral-regs-only */
  OPT_mgfni = 1855,                          /* -mgfni */
  OPT_mhard_float = 1856,                    /* -mhard-float */
  OPT_mharden_sls_ = 1857,                   /* -mharden-sls= */
  OPT_mhle = 1858,                           /* -mhle */
  OPT_mhreset = 1859,                        /* -mhreset */
  OPT_miamcu = 1860,                         /* -miamcu */
  OPT_mieee_fp = 1861,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1862,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 1863,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 1864,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1865,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1866,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1867,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1868,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1869, */            /* -mintel-syntax */
  OPT_mkl = 1870,                            /* -mkl */
  OPT_mlarge_data_threshold_ = 1871,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1872,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1873,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1874,                /* -mlong-double-80 */
  OPT_mlwp = 1875,                           /* -mlwp */
  OPT_mlzcnt = 1876,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1877,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1878,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1879,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1880,                  /* -mmitigate-rop */
  OPT_mmmx = 1881,                           /* -mmmx */
  OPT_mmovbe = 1882,                         /* -mmovbe */
  OPT_mmovdir64b = 1883,                     /* -mmovdir64b */
  OPT_mmovdiri = 1884,                       /* -mmovdiri */
  OPT_mmove_max_ = 1885,                     /* -mmove-max= */
  OPT_mmpx = 1886,                           /* -mmpx */
  OPT_mms_bitfields = 1887,                  /* -mms-bitfields */
  OPT_mmwait = 1888,                         /* -mmwait */
  OPT_mmwaitx = 1889,                        /* -mmwaitx */
  OPT_mneeded = 1890,                        /* -mneeded */
  OPT_mno_align_stringops = 1891,            /* -mno-align-stringops */
  OPT_mno_default = 1892,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1893,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1894,                  /* -mno-push-args */
  OPT_mno_red_zone = 1895,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1896,                       /* -mno-sse4 */
  OPT_mnop_fun_dllimport = 1897,             /* -mnop-fun-dllimport */
  OPT_mnop_mcount = 1898,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1899,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1900,                          /* -mpc32 */
  OPT_mpc64 = 1901,                          /* -mpc64 */
  OPT_mpc80 = 1902,                          /* -mpc80 */
  OPT_mpclmul = 1903,                        /* -mpclmul */
  OPT_mpcommit = 1904,                       /* -mpcommit */
  OPT_mpconfig = 1905,                       /* -mpconfig */
  OPT_mpe_aligned_commons = 1906,            /* -mpe-aligned-commons */
  OPT_mpku = 1907,                           /* -mpku */
  OPT_mpopcnt = 1908,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1909, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1910,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1911,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1912,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1913,                        /* -mprfchw */
  OPT_mptwrite = 1914,                       /* -mptwrite */
  OPT_mpush_args = 1915,                     /* -mpush-args */
  OPT_mrdpid = 1916,                         /* -mrdpid */
  OPT_mrdrnd = 1917,                         /* -mrdrnd */
  OPT_mrdseed = 1918,                        /* -mrdseed */
  OPT_mrecip = 1919,                         /* -mrecip */
  OPT_mrecip_ = 1920,                        /* -mrecip= */
  OPT_mrecord_mcount = 1921,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1922,                 /* -mrecord-return */
  OPT_mred_zone = 1923,                      /* -mred-zone */
  OPT_mregparm_ = 1924,                      /* -mregparm= */
  OPT_mrelax_cmpxchg_loop = 1925,            /* -mrelax-cmpxchg-loop */
  OPT_mrtd = 1926,                           /* -mrtd */
  OPT_mrtm = 1927,                           /* -mrtm */
  OPT_msahf = 1928,                          /* -msahf */
  /* OPT_mscatter = 1929, */                 /* -mscatter */
  OPT_mserialize = 1930,                     /* -mserialize */
  OPT_msgx = 1931,                           /* -msgx */
  OPT_msha = 1932,                           /* -msha */
  OPT_mshstk = 1933,                         /* -mshstk */
  OPT_mskip_rax_setup = 1934,                /* -mskip-rax-setup */
  OPT_msoft_float = 1935,                    /* -msoft-float */
  OPT_msse = 1936,                           /* -msse */
  OPT_msse2 = 1937,                          /* -msse2 */
  OPT_msse2avx = 1938,                       /* -msse2avx */
  OPT_msse3 = 1939,                          /* -msse3 */
  OPT_msse4 = 1940,                          /* -msse4 */
  OPT_msse4_1 = 1941,                        /* -msse4.1 */
  OPT_msse4_2 = 1942,                        /* -msse4.2 */
  OPT_msse4a = 1943,                         /* -msse4a */
  /* OPT_msse5 = 1944, */                    /* -msse5 */
  OPT_msseregparm = 1945,                    /* -msseregparm */
  OPT_mssse3 = 1946,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1947,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1948, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1949,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1950, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1951,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1952,                  /* -mstackrealign */
  OPT_mstore_max_ = 1953,                    /* -mstore-max= */
  OPT_mstringop_strategy_ = 1954,            /* -mstringop-strategy= */
  OPT_mstv = 1955,                           /* -mstv */
  OPT_mtbm = 1956,                           /* -mtbm */
  OPT_mthreads = 1957,                       /* -mthreads */
  OPT_mtls_dialect_ = 1958,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1959,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 1960,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 1961,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1962,                         /* -mtune= */
  OPT_muintr = 1963,                         /* -muintr */
  OPT_municode = 1964,                       /* -municode */
  OPT_muse_libstdc_wrappers = 1965,          /* -muse-libstdc-wrappers */
  OPT_mvaes = 1966,                          /* -mvaes */
  OPT_mveclibabi_ = 1967,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1968,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1969,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1970,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1971,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1972,                      /* -mwbnoinvd */
  OPT_mwidekl = 1973,                        /* -mwidekl */
  OPT_mwin32 = 1974,                         /* -mwin32 */
  OPT_mwindows = 1975,                       /* -mwindows */
  OPT_mx32 = 1976,                           /* -mx32 */
  OPT_mxop = 1977,                           /* -mxop */
  OPT_mxsave = 1978,                         /* -mxsave */
  OPT_mxsavec = 1979,                        /* -mxsavec */
  OPT_mxsaveopt = 1980,                      /* -mxsaveopt */
  OPT_mxsaves = 1981,                        /* -mxsaves */
  OPT_n = 1982,                              /* -n */
  OPT_name_sort = 1983,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1984,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1985,              /* -no-integrated-cpp */
  OPT_no_pie = 1986,                         /* -no-pie */
  OPT_no_pthread = 1987,                     /* -no-pthread */
  ...
  OPT_o = 1996,                              /* -o */
  OPT_objects = 1997,                        /* -objects */
  OPT_p = 1998,                              /* -p */
  OPT_pass_exit_codes = 1999,                /* -pass-exit-codes */
  /* OPT_pedantic = 2000, */                 /* -pedantic */
  OPT_pedantic_errors = 2001,                /* -pedantic-errors */
  OPT_pg = 2002,                             /* -pg */
  OPT_pie = 2003,                            /* -pie */
  OPT_pipe = 2004,                           /* -pipe */
  OPT_posix = 2005,                          /* -posix */
  ...
  OPT_pthread = 2018,                        /* -pthread */
  OPT_quiet = 2019,                          /* -quiet */
  OPT_r = 2020,                              /* -r */
  OPT_remap = 2021,                          /* -remap */
  OPT_reverse_sort = 2022,                   /* -reverse-sort */
  OPT_s = 2023,                              /* -s */
  OPT_save_temps = 2024,                     /* -save-temps */
  OPT_save_temps_ = 2025,                    /* -save-temps= */
  OPT_shared = 2026,                         /* -shared */
  OPT_shared_libgcc = 2027,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2028,               /* -shared-libphobos */
  OPT_size_sort = 2029,                      /* -size-sort */
  /* OPT_specs = 2030, */                    /* -specs */
  OPT_specs_ = 2031,                         /* -specs= */
  OPT_static = 2032,                         /* -static */
  OPT_static_libasan = 2033,                 /* -static-libasan */
  OPT_static_libgcc = 2034,                  /* -static-libgcc */
  OPT_static_libgfortran = 2035,             /* -static-libgfortran */
  ...
  OPT_static_libstdc__ = 2042,               /* -static-libstdc++ */
  OPT_static_libtsan = 2043,                 /* -static-libtsan */
  OPT_static_libubsan = 2044,                /* -static-libubsan */
  OPT_static_pie = 2045,                     /* -static-pie */
  /* OPT_std_c__03 = 2046, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2047, */                /* -std=c++0x */
  OPT_std_c__11 = 2048,                      /* -std=c++11 */
  OPT_std_c__14 = 2049,                      /* -std=c++14 */
  OPT_std_c__17 = 2050,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2051, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2052, */                /* -std=c++1z */
  OPT_std_c__20 = 2053,                      /* -std=c++20 */
  OPT_std_c__23 = 2054,                      /* -std=c++23 */
  /* OPT_std_c__2a = 2055, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2056, */                /* -std=c++2b */
  OPT_std_c__98 = 2057,                      /* -std=c++98 */
  OPT_std_c11 = 2058,                        /* -std=c11 */
  OPT_std_c17 = 2059,                        /* -std=c17 */
  /* OPT_std_c18 = 2060, */                  /* -std=c18 */
  /* OPT_std_c1x = 2061, */                  /* -std=c1x */
  OPT_std_c2x = 2062,                        /* -std=c2x */
  /* OPT_std_c89 = 2063, */                  /* -std=c89 */
  OPT_std_c90 = 2064,                        /* -std=c90 */
  OPT_std_c99 = 2065,                        /* -std=c99 */
  /* OPT_std_c9x = 2066, */                  /* -std=c9x */
  OPT_std_f2003 = 2067,                      /* -std=f2003 */
  OPT_std_f2008 = 2068,                      /* -std=f2008 */
  OPT_std_f2008ts = 2069,                    /* -std=f2008ts */
  OPT_std_f2018 = 2070,                      /* -std=f2018 */
  OPT_std_f95 = 2071,                        /* -std=f95 */
  OPT_std_gnu = 2072,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2073, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2074, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2075,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2076,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2077,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2078, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2079, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2080,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2081,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 2082, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2083, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 2084,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2085,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2086,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2087, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2088, */                /* -std=gnu1x */
  OPT_std_gnu2x = 2089,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 2090, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2091,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2092,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2093, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2094, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2095,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2096, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2097, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2098, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2099, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2100, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 2101,                     /* -std=legacy */
  OPT_stdlib_ = 2102,                        /* -stdlib= */
  OPT_symbol_ = 2103,                        /* -symbol= */
  OPT_symbolic = 2104,                       /* -symbolic */
  OPT_t = 2105,                              /* -t */
  OPT_time = 2106,                           /* -time */
  OPT_time_ = 2107,                          /* -time= */
  OPT_traditional = 2108,                    /* -traditional */
  OPT_traditional_cpp = 2109,                /* -traditional-cpp */
  OPT_tree_stats = 2110,                     /* -tree-stats */
  OPT_trigraphs = 2111,                      /* -trigraphs */
  OPT_type_stats = 2112,                     /* -type-stats */
  OPT_u = 2113,                              /* -u */
  OPT_undef = 2114,                          /* -undef */
  OPT_v = 2115,                              /* -v */
  OPT_version = 2116,                        /* -version */
  OPT_w = 2117,                              /* -w */
  OPT_wrapper = 2118,                        /* -wrapper */
  OPT_x = 2119,                              /* -x */
  OPT_z = 2120,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,

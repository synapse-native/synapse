...
enum unspecv {
  ...
  UNSPECV_HRESET = 83,
  UNSPECV_LDTILECFG = 84,
  UNSPECV_STTILECFG = 85,
  UNSPECV_EMMS = 86,
  UNSPECV_FEMMS = 87,
  UNSPECV_LDMXCSR = 88,
  UNSPECV_STMXCSR = 89,
  ...
  UNSPECV_MWAIT = 92,
  UNSPECV_VZEROALL = 93,
  UNSPECV_LOADIWKEY = 94,
  UNSPECV_AESDEC128KLU8 = 95,
  UNSPECV_AESENC128KLU8 = 96,
  UNSPECV_AESDEC256KLU8 = 97,
  UNSPECV_AESENC256KLU8 = 98,
  UNSPECV_AESDECWIDE128KLU8 = 99,
  UNSPECV_AESENCWIDE128KLU8 = 100,
  UNSPECV_AESDECWIDE256KLU8 = 101,
  UNSPECV_AESENCWIDE256KLU8 = 102,
  UNSPECV_ENCODEKEY128U32 = 103,
  UNSPECV_ENCODEKEY256U32 = 104,
  UNSPECV_CMPXCHG = 105,
  UNSPECV_XCHG = 106,
  UNSPECV_LOCK = 107
};
#define NUM_UNSPECV_VALUES 108

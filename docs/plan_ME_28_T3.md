# plan_ME_28_T3 — TDD F27-F30: Certificación Syquex v1.0 - parte 3

MTS (docs/METODO_TRABAJO.md). Oráculo ejecutable; el código lleva cita grep-chequeable.

## Requisito
requisito: Manual 3 (certificación)
texto: "Syquex debe certificarse v1.0: integración end-to-end (Hito 7, F28)."
implementacion: Crear tests/integration/test_syquex_cert_3.py con oráculo e2e de certificación. RED hasta F28.

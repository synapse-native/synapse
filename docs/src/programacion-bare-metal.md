...
Synapse v2.1 extiende su alcance más allá de las aplicaciones con sistema operativo. La directiva `#pragma: no_std` transforma el compilador en una herramienta de desarrollo de sistemas de bajo nivel, ideal para kernels, bootloaders, firmware embebido y entornos de tiempo real (RTOS).

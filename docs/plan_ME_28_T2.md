# plan_ME_28_T2 — TDD F27-F30: Certificación Syquex v1.0 - parte 2

MTS (docs/METODO_TRABAJO.md). Oráculo ejecutable; el código lleva cita grep-chequeable.

## Requisito
requisito: Manual 3 (certificación)
texto: "Syquex debe certificarse v1.0: semántica y traducción conformes (Hito 7, F28)."
implementacion: Crear tests/integration/test_syquex_cert_2.py con oráculos de certificación de M3. RED hasta F28.

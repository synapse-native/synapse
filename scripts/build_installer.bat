...
REM Valida que el artefacto binario resultante se empaquete correctamente en dist/Synapse-5.1.1-industrial-Windows-x64.exe
...
set OUTPUT_EXE=dist\Synapse-5.1.1-industrial-Windows-x64.exe

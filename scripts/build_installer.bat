...
REM Valida que el artefacto binario resultante se empaquete correctamente en dist/Synapse-8.1.0-industrial-Windows-x64.exe
...
set OUTPUT_EXE=dist\Synapse-8.1.0-industrial-Windows-x64.exe

...
const char* {_PH}mt(const char* st) {{
    ...
    if(strcmp(_bare,"rc")==0||strcmp(_bare,"arc")==0||strcmp(_bare,"debil")==0||strcmp(_bare,"d\u00e9bil")==0||strcmp(_bare,"weak")==0||strcmp(_bare,"faible")==0||strcmp(_bare,"fraco")==0) _r="void*";
